...
CREATE DATABASE IF NOT EXISTS vendas_sql_reports;
USE vendas_sql_reports;

-- 1. Tabela Shippers (Transportadoras)
-- Baseado nas colunas ShipperID, ShipperName, Phone [1]
...
-- Baseado nas colunas EmployeeID, LastName, FirstName, BirthDate, Photo, Notes [2]
CREATE TABLE Employees (
    EmployeeID INT NOT NULL PRIMARY KEY,
    LastName VARCHAR(255) NOT NULL,
    FirstName VARCHAR(255) NOT NULL,
    BirthDate DATE, -- Data de Nascimento. O formato nos dados é DD/MM/YYYY [2].
    Photo VARCHAR(255),
    Notes TEXT -- Usando TEXT para armazenar informações detalhadas como formação e histórico [2].
);

-- 3. Tabela Customers (Clientes)
-- Baseado nas colunas CustomerID, CustomerName, ContactName, Address, City, PostalCode, Country [3]
...
-- Baseado nas colunas SupplierID, SupplierName, ContactName, Address, City, PostalCode, Country, Phone [4]
...
-- Baseado nas colunas ProductID, ProductName, SupplierID, CategoryID, Unit, Price [5]
CREATE TABLE Products (
    ProductID INT NOT NULL PRIMARY KEY,
    ProductName VARCHAR(255) NOT NULL,
    SupplierID INT, -- Chave estrangeira para Suppliers [5]
    CategoryID INT, -- Categorias não foram detalhadas, mas o ID está presente [5].
    Unit VARCHAR(255),
    Price DECIMAL(10, 2), -- Usando DECIMAL para preços. O formato nos dados usa vírgula (e.g., 18,00) [5], mas o MySQL usa ponto para separação decimal.
    FOREIGN KEY (SupplierID) REFERENCES Suppliers(SupplierID)
);

-- 6. Tabela Orders (Pedidos)
-- Baseado nas colunas OrderID, CustomerID, EmployeeID, OrderDate, ShipperID [6]
CREATE TABLE Orders (
    OrderID INT NOT NULL PRIMARY KEY,
    CustomerID INT, -- Chave estrangeira para Customers [6]
    EmployeeID INT, -- Chave estrangeira para Employees [6]
    OrderDate DATE, -- Data do pedido. O formato nos dados é DD/MM/YYYY [6].
    ShipperID INT, -- Chave estrangeira para Shippers [6]
    FOREIGN KEY (CustomerID) REFERENCES Customers(CustomerID),
    FOREIGN KEY (EmployeeID) REFERENCES Employees(EmployeeID),
    FOREIGN KEY (ShipperID) REFERENCES Shippers(ShipperID)
);

-- 7. Tabela OrderDetails (Detalhes do Pedido)
-- Esta é a tabela de junção/detalhe. Baseado nas colunas OrderDetailID, OrderID, ProductID, Quantity [7]
CREATE TABLE OrderDetails (
    OrderDetailID INT NOT NULL PRIMARY KEY, -- Usando esta coluna como PK conforme o dado de origem [7]
    OrderID INT NOT NULL, -- Chave estrangeira para Orders [7]
    ProductID INT NOT NULL, -- Chave estrangeira para Products [7]
...
-- Inserindo dados na tabela Shippers
...
-- Inserindo dados na tabela Suppliers
...
-- Inserindo dados na tabela Orders (Apenas as primeiras linhas, o total é longo)
